    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "filter": (["All", "Illustrious", "Pony", "SDXL", "SD15"], { "default": "All" }),
                "lora_name": (folder_paths.get_filename_list("loras"), ),
                "strength_model": ("FLOAT", {"default": 1.0, "min": -100.0, "max": 100.0, "step": 0.01}),
                "strength_clip": ("FLOAT", {"default": 1.0, "min": -100.0, "max": 100.0, "step": 0.01}),
                "base": (["", "Illustrious", "Pony", "SDXL", "SD15"], { "default": "" }),
                "hash": ("STRING", {"default": ""}),
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "gen_info": ("GENINFO",),
                "bypass": (['Yes', 'No'], { "default": 'No' }),
                "filter": (["All", "Flux", "Illustrious", "Pony", "SDXL", "SD15"], { "default": "All" }),
                "lora_name": (folder_paths.get_filename_list("loras"), ),
                "strength_model": ("FLOAT", {"default": 1.0, "min": -100.0, "max": 100.0, "step": 0.01}),
                "base": (["", "Flux", "Illustrious", "Pony", "SDXL", "SD15"], { "default": "" }),
                "hash": ("STRING", {"default": ""}),
                "triggers": ("STRING", { "multiline": True }),
                "url": ("STRING", {"default": ""}),
            }
